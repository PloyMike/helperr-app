...
function EditProfilePage() {
  ...
  const citiesByCountry = {
    ...
    'Thailand': ['Ang Thong', 'Ao Nang', 'Ayutthaya', 'Baan Kai', 'Baan Tai', 'Bangkok', 'Bophut', 'Bueng Kan', 'Buriram', 'Chachoengsao', 'Chai Nat', 'Chaiyaphum', 'Chaloklum', 'Chalok Baan Kao', 'Chanthaburi', 'Chaweng', 'Chiang Mai', 'Chiang Rai', 'Chonburi', 'Chumphon', 'Haad Rin', 'Hat Yai', 'Hua Hin', 'Kalasin', 'Kamala', 'Kamphaeng Phet', 'Kanchanaburi', 'Karon', 'Kata', 'Khao Lak', 'Khon Kaen', 'Koh Chang', 'Koh Lanta', 'Koh Lipe', 'Koh Mak', 'Koh Phangan', 'Koh Phi Phi', 'Koh Samui', 'Koh Tao', 'Koh Yao Noi', 'Krabi', 'Lampang', 'Lamai', 'Lamphun', 'Lipa Noi', 'Loei', 'Lopburi', 'Mae Haad', 'Mae Hong Son', 'Maenam', 'Maha Sarakham', 'Mukdahan', 'Nakhon Nayok', 'Nakhon Pathom', 'Nakhon Phanom', 'Nakhon Ratchasima', 'Nakhon Sawan', 'Nakhon Si Thammarat', 'Nan', 'Narathiwat', 'Nathon', 'Nong Bua Lamphu', 'Nong Khai', 'Nonthaburi', 'Pai', 'Patong', 'Pathum Thani', 'Pattani', 'Pattaya', 'Phang Nga', 'Phatthalung', 'Phayao', 'Phetchabun', 'Phetchaburi', 'Phichit', 'Phitsanulok', 'Phrae', 'Phuket', 'Prachinburi', 'Prachuap Khiri Khan', 'Railay', 'Ranong', 'Ratchaburi', 'Rawai', 'Rayong', 'Roi Et', 'Sa Kaeo', 'Sairee Beach', 'Sakon Nakhon', 'Samut Prakan', 'Samut Sakhon', 'Samut Songkhram', 'Saraburi', 'Satun', 'Sing Buri', 'Sisaket', 'Songkhla', 'Sukhothai', 'Suphanburi', 'Surat Thani', 'Surin', 'Tak', 'Thong Sala', 'Trang', 'Trat', 'Ubon Ratchathani', 'Udon Thani', 'Uthai Thani', 'Uttaradit', 'Yala', 'Yasothon'],
