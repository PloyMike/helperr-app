...
// Ersetze den kompletten Hero-Bereich
const oldHero = /<div style={{position:'relative',overflow:'hidden',padding:'75px 20px 25px',marginTop:70}}>[\s\S]*?<div style={{maxWidth:1200,margin:'0 auto',position:'relative',zIndex:2,color:'#1F2937'}}/;

const newHero = `<div style={{position:'relative',overflow:'hidden',padding:'75px 20px 25px',marginTop:70}}>
...
console.log('✅ ProfilDetail hero is now white!');
