...
// Ersetze timeSlots mit Zeitbereichen
content = content.replace(
  /\/\/ CHRONOLOGISCHER 24-STUNDEN-TAG[\s\S]*?const timeSlots = \[[\s\S]*?\];/,
  `// CHRONOLOGISCHER 24-STUNDEN-TAG MIT ZEITBEREICHEN
  const timeSlots = [
...
console.log('✅ Zeitbereiche hinzugefügt: 00:00 - 01:00 bis 23:00 - 00:00');
